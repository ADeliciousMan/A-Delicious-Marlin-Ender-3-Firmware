 ...
 *
 * - Higher values may affect repeatability or accuracy of some bed `s.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
// Default is { 500, 500, 100, 5000 } - DELICIOUS
...
// Default for all 3 (DEFAULT_ACCELERATION, DEFAULT_RETRACT_ACCELERATION, DEFAULT_TRAVEL_ACCELERATION) is 500 - DELICIOUS
// Can possibly be as high as 3000 for each - DELICIOUS
...
// Default is (30, 30, 30, 30) - Changed to work with BED_TRAMMING_USE_PROBE - DELICIOUS
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 49, 30 } // (mm) Left, Front, Right, Back insets
